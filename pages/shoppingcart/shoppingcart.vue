          ...
          <view class="sahngpin">
            <view class="left floctcont">
              <view @tap="details(item.goods_id)" class="navigator">
                <image
                  class="cart-thumb"
                  :src="item.goods_sku.spec_image?item.goods_sku.spec_image:item.goods.image"
                  mode="scaleToFill"
                />
              </view>
            </view>
  ...
  methods: {
    ...
    orderDown() {
      ...
      if (ct_id) {
        ...
        uni.navigateTo({
          url:
            "/pages/product-detail/sureOrder/sureOrder?sureOrder=" +
