  ...
  <view>
    <view class="top_title">
      ...
      <navigator url="../shoppingcart/shoppingcart">
        <image src="/static/index/gwc.png" class="icon2" />
      </navigator>
    </view>
    <!-- 商品详情 -->
      ...
      <view class="team-buy-detail" v-for="(data, index) in teamlist.splice(0, 2)" :key="index">
        ...
        <view class="assmebleright">
          <view>
            <view class="pingtuan">
              差
              <text style="font-size: 28rpx;color:#E02020;">{{ data.num }}</text>人拼成
            </view>
    ...
    <scroll-view class="commodity_attr_list" v-if="sku_show" scroll-y="true">
      ...
      <view class="buyNum">
        ...
        <view class="buyNumRight">
          ...
          <text
            :class="'buyNumAdd ' + (buyQuantity >= shopGooesNum ? 'buyNumAddbg' : '')"
            @tap="addCount"
            style="display:flex;align-item:center;justify-content:center;"
          >+</text>
        </view>
