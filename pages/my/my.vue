	...
	<view class="page">
		...
		<view class="user_info p_r_l_32">
			<view class="left_side">
				...
				<view class="info_wrap">
					...
					<view class="date">像风一样自由</view>
				</view>
			</view>

			<navigator class="signin_btn" url="/pages/my/daySignin/daySignin">
				<image src="../../static/my/dateimg.png" mode=""></image>
				<text>签到</text>
			</navigator>
		</view>
		...
		<view class="panel">
			<navigator url="mycollect/mycollect">
				<view class="left_side">
					<image src="../../static/my/wdsc.png" mode=""></image>
					<text>我的收藏</text>
				</view>
				<image src="../../static/index/qj.png" class="icon_more"></image>
			</navigator>
		...
		<view class="panel">
			<navigator url="huiyuanxinxi/huiyuanxinxi">
				<view class="left_side">
					<image src="../../static/my/hyxx.png" mode=""></image>
					<text>会员信息</text>
				</view>
				<image src="../../static/index/qj.png" class="icon_more"></image>
			</navigator>
			<navigator url="huiyuantequan/huiyuantequan">
				<view class="left_side">
					<image src="../../static/my/hytq2.png" mode=""></image>
					<text>会员特权</text>
				</view>
				<image src="../../static/index/qj.png" class="icon_more"></image>
			</navigator>
			...
			<navigator url="jifenguize/jifenguize">
				<view class="left_side">
					<image src="../../static/my/jfgz.png" mode=""></image>
					<text>积分规则</text>
				</view>
				<image src="../../static/index/qj.png" class="icon_more"></image>
			</navigator>
