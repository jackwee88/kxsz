...
export default {
  ...
  onLoad: function(options) {
    ...
    if (options.way == 1) {
      (this.way = 1),
        ...
        (this.prv_money = options.prv_money),
        (this.p_id = options.p_id),
        (this.ct_id = options.ct_id),
        (this.ar_id = options.ar_id),
  ...
  methods: {
    ...
    checkboxChange: function(e) {
      ...
      (this.checkValue = checkValue), (this.checkboxArr = checkboxArr);
      ...
      if (this.data.checkValue == true) {
        if (this.data.way == 1) {
          ...
          var moneys = 0;
          let tols =
            parseFloat(this.data.money) +
            parseFloat(this.data.prv_money) -
            parseFloat(moneys);
