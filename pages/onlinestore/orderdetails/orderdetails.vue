    ...
    <view class="delivery clear">
      ...
      <view :class="'address clear ' + (details.logistics.length == 0 ? 'if-wuli':'')">
        <view class="address-left">
          <image class="cion" src="/static/img/onlinestore/address.png" />
        </view>
        <view class="address-right">
          <view class="user">
            {{details.username}}
            <text class="tel">{{details.mobile}}</text>
          </view>
          <view
            class="address"
          >{{details.province}} {{details.city}} {{details.area}} {{details.address}}</view>
        </view>
      </view>
    </view>
    ...
    <view class="sureorder clear">
      <view class="store">
        ...
        <block v-for="(items, index) in details.goods" :key="index">
          <view class="storeList clear">
            <view class="store_left stroedetail">
              <image class="storeimg" :src="items.image" />
            </view>
          ...
          <view
            class="storeList clear"
            v-if="items.video"
            v-for="(videoitems, index2) in items.video"
            :key="index2"
          >
            <view class="store_left stroedetail">
              <image class="storeimg" :src="videoitems.thumb" />
            </view>
            <view class="store_mid stroedetail clear">
        ...
        <text class='total'>总计：￥{{items.real_money}}</text>
          ...
          <view
            class="storeList clear"
            v-if="items.bindpacks"
            v-for="(bindpacksitems, index2) in items.bindpacks"
            :key="index2"
          >
            <view class="store_left stroedetail">
              <image class="storeimg" :src="bindpacksitems.icon" />
            </view>
            <view class="store_mid stroedetail clear">
        ...
        <view class="orderButton">
          <block v-if="details.refund_status == 1">
            <view
              class="button"
              v-if="(details.status==0 &&  details.is_refund==1) || (details.status==1 &&  details.is_refund==1) || (details.status==2 && details.is_refund==1)"
